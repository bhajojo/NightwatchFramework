module.exports = {
     'Test My Pages eSignMessage' : function (client) {
      ...
      //Verify the Message in eSignIN
       var eSignMessage=client.page.eSignMessage("agrol")
       eSignMessage.LoadMoreMessage()
       eSignMessage.VerifyNotificationeSignIN()
       eSignMessage.VerifyeSignINfunctionality()
