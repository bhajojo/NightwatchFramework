module.exports = {
  'Test Preferences functionality' : function (client) {
      ...
      var Preferences=client.page.Preferences()

      Preferences.VerifyPreferences()
      Preferences.CommunicationMethod()
      Preferences.VerifyQuicklinkHidden()
      Preferences.VerifyPreferences()
      Preferences.VerifyQuicklinkVisible()
      Preferences.VerifyPreferences()
      Preferences.VerifyCardnicknames("agrol")
    }
};
